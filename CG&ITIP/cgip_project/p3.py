...
def adjust_window_size(img_width, img_height):
    root.geometry(f"{img_width * 2 + 300}x{img_height + 200}")
...
img_display_original.pack(padx=10, pady=10, side=tk.LEFT)

# Edited Image Display
img_display = tk.Label(frame, bd=10, relief="groove")
img_display.pack(padx=10, pady=10, side=tk.LEFT)

# Image Manipulation Frames
